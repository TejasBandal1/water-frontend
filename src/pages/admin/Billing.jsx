                  ...
                  <Fragment key={row.client_id}>
                    <tr>
                      <td>
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          Period: {getMonthLabel(activePeriod.year, activePeriod.month)}
                        </p>
                      </td>
                      <td>
                        <div className="grid min-w-[220px] grid-cols-2 gap-x-4 gap-y-2 text-xs">
                          ...
                          <div className="space-y-1.5">
                            {row.pending_invoices.slice(0, 3).map((inv) => (
                              ...
                              >
                                ...
                                <span className="ml-2 uppercase">{inv.status}</span>
                    ...
                    {expanded && (
                      <tr key={`${row.client_id}_details`}>
                        <td colSpan={5}>
                          <div className="my-2 grid gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 lg:grid-cols-3">
